...
/**
 * Registry to store the available console output renderers {@link OutputConsoleRenderer} 
 * as well as links between their types and the types of command {@link Command} 
 *
