 ...
 */
public class AutoSaveModeImpl implements AutoSaveMode, EditorSettingsChangedHandler, ActivePartChangedHandler {
...
//        Log.error(getClass(), "********************************** CONSTRUCTOR " + this.hashCode());
    ...
    public void uninstall() {
        saveTimer.cancel();
        //TODO send event on server side ???
    }
...
//            Log.error(getClass(), "/////////////////////// editor != activeEditor");
            return;
        }
