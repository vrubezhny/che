...
public class RenderersPage  extends AbstractCommandEditorPage implements RenderersPageView.ActionDelegate,
  ...
  @Inject
  public RenderersPage(RenderersPageView view,
  ...
  protected void initialize() {
    ...
    if (applicableRenderers == null) {
      applicableRenderers = rendererRegistry.getCommandDefaultOutputRenderers(editedCommand.getType());
  ...
  private void refreshRenderers() {
    ...
    rendererRegistry.getAllOutputRenderers().forEach(c -> {
        renderersStates.put(c, 
            applicableRenderers != null && applicableRenderers.contains(c.getName()));
        });
