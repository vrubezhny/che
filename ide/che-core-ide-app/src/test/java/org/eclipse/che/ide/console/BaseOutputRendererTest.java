...
public class BaseOutputRendererTest {
  ...
  /**
   * Sets the Renderer to be tested and array of all the renderers. Normally is to be called
  ...
  /**
   * Tests the lines that cannot be treated as stacktrace lines and, as such,
  ...
  /**
   * Tests the text lines (those that can be processed as well as those that cannot be 
   * processed)
   *
  ...
  protected void testStackTraceLine(
      @SuppressWarnings("rawtypes") Class expectedRendererClass, String line, String expectedCustomization) throws Exception {
  ...
  private void testRendererValidity(
      @SuppressWarnings("rawtypes") Class expectedRendererClass, OutputConsoleRenderer[] allRenderers, String text) {
    Assert.assertTrue(
