...
public class JavaOutputRendererTest extends BaseOutputRendererTest {
  ...
  /**
   * Test for the detection of informative stacktrace lines in JavaOutputRenderer. These lines
  ...
  /**
   * Test for the detection of other stacktrace lines in JavaOutputRenderer. Other lines that can
