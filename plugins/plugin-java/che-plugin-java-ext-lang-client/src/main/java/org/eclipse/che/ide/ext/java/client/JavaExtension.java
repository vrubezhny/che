...
public class JavaExtension {
  ...
  public JavaExtension(
    ...
    rendererRegistry.register(JAVA_CATEGORY, 
        new JavaOutputRenderer(JAVA_CATEGORY, appContext, editorAgent));  
    rendererRegistry.register(JAVASCRIPT_CATEGORY, 
        new JavaOutputRenderer(JAVASCRIPT_CATEGORY, appContext, editorAgent));  
  }
