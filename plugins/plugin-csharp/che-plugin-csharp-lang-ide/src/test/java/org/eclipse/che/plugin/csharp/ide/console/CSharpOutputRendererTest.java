...
public class CSharpOutputRendererTest extends BaseOutputRendererTest {
   ...
   * These lines are not to be rendered, however these lines show an example of 
   ...
   * Java ones) that must not be rendered in CSharpOutputRenderer. Other lines that might occur
   * in output console
   *
   * @throws Exception
   */
