...
public class CSharpOutputRendererTest extends BaseOutputRendererTest {
    ...
    public void setUp() throws Exception {
        OutputConsoleRenderer outputRenderer = new CSharpOutputRenderer(CSharpExtension.CSHARP_CATEGORY, appContext, editorAgent);
        setupTestRenderers(outputRenderer, new OutputConsoleRenderer[] { outputRenderer });
    }

    /**
     * Test for the detection of initial stacktrace lines in CSharpOutputRenderer.
     * These lines are not to be rendered, however these lines show an examples of
     * beginning the StackTrace and might be used in future to set up the renderer
     * properly.
     * 
     * @throws Exception
     */
     ...
     * CSharpOutputRenderer. These lines have an information on file path and line
    ...
    public void testValuableStackTraceLines() throws Exception {
        testStackTraceLine(CSharpOutputRenderer.class,
     ...
     * CSharpOutputRenderer. These lines have an information on file relative
     ...
     * CSharpOutputRenderer. Other lines that might occur in output console
     * 
     * @throws Exception
     */
    @Test
